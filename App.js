...
const TOKEN="7207643438:AAGNlV-VI1_4xI2kFvqe6xA37wkXkCyiRW8"
...
const bot = new TelegramBot(token, { polling : true, pollingTimeout : 30000 });
...
app.listen(port, () => {
  console.log(`Server running on port ${port} 123`);
});
